...
const options = {
	...
	pixelRatio: 1,
	perlin: {
		speed: 0.00025910245554614734,
		decay: 0.30143945808636746,
		complexity: 0.5566299745977984,
		waves: 20.0,
		saturation: 0,
		huediff: 11.0,
		point: 1.5,
...
function animation(enviroment){
	...
	faceData.forEach(({scale, ...props} = {}, index) => {
		...
		const translateX = (-0.5 + (postX/640)) * (factorX * -1)
